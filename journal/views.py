...
from .forms import CreateUserFrom,LoginForm,ThoughtForm,UpdateUserForm,UpdateProfileForm
...
def register(request):
    ...
    if request.method== 'POST':
        ...
        if(form.is_valid()):
            ...
            form.save()
            send_mail("Welcome To MindVault","Congratulations on creating your account",settings.DEFAULT_FROM_EMAIL,[current_user.email])
